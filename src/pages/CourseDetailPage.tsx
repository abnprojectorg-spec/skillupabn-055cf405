...
import { Star, Users, Clock, BookOpen, ArrowLeft, CheckCircle } from "lucide-react";

const CourseDetailPage = () => {
  const { id } = useParams();
  const course = COURSES.find((c) => c.id === id);
  const isUnlocked = MOCK_USER.coursesUnlocked.includes(id || "");
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 rounded-2xl border border-border bg-card p-6">
                <div className="text-center mb-6">
                  <p className="font-display text-3xl font-bold">{course.price} ETB</p>
